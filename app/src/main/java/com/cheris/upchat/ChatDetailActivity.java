...
import com.cheris.upchat.Adapter.ChatDetailAdapter;
import com.cheris.upchat.Model.MessageModel;
...
public class ChatDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ChatDetailAdapter chatDetailAdapter  = new ChatDetailAdapter(messageModels, this);
        binding.chatRecyclerView.setAdapter(chatDetailAdapter);
